...
import application.xmlMappedClasses.MusicPlayer;
import application.xmlMappedClasses.TestBean;
...
public class SpringXMLConfigurationTest {
     ...
     * create with context Player and play track*/
    @Test
    ...
    /**This is test of annotation @Component */
    @Test
    public void annotationExample()
    {
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("context.xml");
        Music music = context.getBean("rap_music", Music.class);
        MusicPlayer player = new MusicPlayer(music);
        player.playMusic();
    }
